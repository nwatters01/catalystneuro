...
mkdir /om2/user/nwatters/multi_prediction/phys_data/Elgar/2022-06-22/raw_data/spikeglx_v7

bash runit.sh \
-dir=/om2/user/nwatters/multi_prediction/phys_data/Elgar/2022-06-22/raw_data/spikeglx/ \
-run=2022_06_22_elgar_task \
-dest=/om2/user/nwatters/multi_prediction/phys_data/Elgar/2022-06-22/raw_data/spikeglx_v7/ \
-no_run_fld \
-ap \
-prb=0 \
-g=0 \

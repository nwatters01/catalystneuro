"""MWorks reader that runs without Mac OS.

The normal python MWorks reader requires Mac OS. This is a workaround that can
run on linux, so can be used on Openmind.
"""
